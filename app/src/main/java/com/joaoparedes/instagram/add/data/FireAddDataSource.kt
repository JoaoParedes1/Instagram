...
class FireAddDataSource : AddDataSource {
    ...
    override fun createPost(userUUID: String,uri: Uri,caption: String,callback: RequestCallback<Boolean>) {
        val uriLastPath = uri.lastPathSegment ?: throw IllegalArgumentException("imvalid img")
                ...
                imgRef.downloadUrl
                    .addOnSuccessListener { resDownload ->
                        ...
                        meRef.get()
                                ...
                                postRef.set(post)
                                    .addOnSuccessListener {
                                        ...
                                        FirebaseFirestore.getInstance()
                                            ...
                                            .addOnFailureListener{ exception ->
                                                callback.onFailure(exception.message ?: "Falha ao postar no feed")
                                            }
                            ...
                            .addOnFailureListener{ exception ->
                                callback.onFailure(exception.message ?: "Falha ao buscar usuario logado")
                            }
